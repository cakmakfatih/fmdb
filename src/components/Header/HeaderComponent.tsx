...
export function HeaderComponent(props: MainState) {
  const { isHeaderSticky } = props;

  return (
    <header className="border-slate-700 z-10 flex flex-col items-stretch justify-between border-b">
      <section
      ...
      >
        <MaxWidthLayoutComponent className="justify-between select-none">
      ...
      >
        <MaxWidthLayoutComponent className="select-none mx-6">
